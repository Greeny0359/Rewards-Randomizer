...
local CardLocators = {
	{ --Level 1
		...
		--Credits Greeny0359
		{323.165680,10.651782,-117.792542,"Top of Evergreen Terrace Sign"},
		{368.540131,7.708017,-65.267410,"Next to graveyard where 4-b stats"},
		{374.579010,7.922404,80.253380,"In graveyard glass near Lenny"},
		{389.147797,6.732915,-8.039285,"In graveyard on top of dog house"},
		{381.521240,7.944163,145.374741,"Behind Krusty Burger"},
		{-129.47454833984,24.520244598389,-461.41424560547,"On tower (same as marge)"},
		{204.336136,9.480519,-294.937459,"On Duff Truck"},
		{194.593597,4.13,395.04,"In the tomacco field"},
		{121.689,6.746,-240.433,"At blue house near Kwik-e-Mart"},
		{42.408,3.133,270.164,"Powerplant Centre"},
		{-90.171,3.557,-215.021,"On top of rocket car"},
		{310.383,5.451,95.972," On box next to gas station"},
		{496.623,-20.000,-396.118,"In Simpsons' house"},
		{-29.706,3.1094,-499.387,"At start of bonestorm"},
		{-32.474,5.762,-589.383,"Front of school"},
		{412.079,0.268,530.641,"Nelson's house"},
		{441.123,-0.072,524.83,"At Moe's house"},
		{225.844,14.896,488.0383,"Above barn"},
		{324.069,3.942,529.886,"Under tirefire jump"},
		{384.685,3.488,460.811,"Traileryard"},
		{311.972,0.0557,365.853,"Cletus' house"},
		{394.776,1.427,325.694,"Run down house near Cletus"},
		{131.164,5.724,-594.338,"Church Sign near carpark"},
		{202.112,4.102,-573.233,"Church Sign near race start"},
		{-38.888,13.746,-566.240,"School Roof"},
		{-40.375,13.670,-610.966,"School Roof"},
		{-57.395,9.820,-526.606,"Sign next to grocery store"},
		{306.606,9.006,-289.982,"Retirement Castle Roof"},
		{298.872,9.86,-277.113,"Retirement Castle Sign"},
		{-394.377,5.611,-77.230,"Stonecutter's tunnel"},
		{133.615,6.855,-487.019,"Driveway in bonestorm shortcut"},
		{159.393,-1.2611,-433.406,"Driveway in bonestorm shortcut"},
		{349.533,4.0233,361.771,"On top of outhouse at Cletus' house"},
		{301.679,4.255,307.889,"House next to Cletus"},
		{457.191,4.905,443.872,"Driveway in trailerpark"},
		{-185.499,1.210,-278.032,"Gas station"},
		{-174.541,-0.9634,302.571,"Wheel of fortune jump"},
		{224.885,8.437,465.943,"In barn shortcut"},
		{208.21,14.66,-360.269,"Firetruck jump"},
		{44.864,6.602,-238.121,"Middle of road next in front of blue house"},
		{131.169,12.327,-227.5199,"Above house jump"},
		{499.212,-20,-354.274,"In school"},
		{-120.304,14.443,-397.912,"Bridge jump next to tower"},
		{199.266,11.976,-363,830,"On top of krusty burger"},
		{-118.063,12.778,-466.519,"Bridgr jump next to tower"},
		{-166.839,18.286,-252.037,"Gas station jump"},
		{-187.891,5.786,-210.462,"Next to Gas station race"},
		{-57.566,4.41,297.422,"Entrance of powerplant"},
		{240.257,10.354,-135.045,"Skinners House"},
		{283.82,22.291,506.439,"Tirefire jump"},
		{-80.61,0.503,3223.632,"Homers workstation"},
		{-2.944,3.206,251.935,"Powerplant carpark"},
		{57.116,2.94,251.855,"Powerplant carpark"},
		{12.313,4.483,336.805,"Powerplant gag"},
		{86.638,5.403,-602.486,"Krusty Burger Dumpster"},
		{-13.231,8.500,-615.94,"School Sign"},
		{182.203,6.409,-370.394,"Firetruck"},
		{199.391,8.074,-346.39,"Firetruck under ladder"},
		{230.037,-0.706,-565.37,"In front of Casa Nova"},
		{-52.460,6.982,-628.408,"Krusty Glass at school"},
		{171.548,9.452,-392.799,"Bonestorm shortcut jump"},
		{52.275,6.721,-153.545,"Behind pink house"},
		{229.325,11.000,-180.717,"Above Simpsons house door"},
		{261.312,4.918,-182.400,"Flanders Front door"},
		{282.3,5.111,-190.07,"Next to flanders"},
		{449.38,9.399,-23.00,"Blue House near pet cemetary"},
		{-125.801,3.613,281.939,"Near power couplings in BBB"},
		{-111.949,3.992,300.679,"BBB"},
		{367.88,10.892,45.010,"Pet cemetary"},
		{208.79608154297,7.7058010101318,-207.27517700195,"Treehouse in Simpson's Backyard"},
		{322.69198608398,13.252814292908,185.37338256836,"Bridge card from marge"},
		{322.69198608398,13.252814292908,246.921,"Bridge card near cletus"},
		{351.69198608398,13.252814292908,246.921,"Bridge card near cletus"},
		{383.195,-1.319,418.828,"Trailerpark corner"},
		{201.306,12.213,538.082 ,"Next to Sign near tommaco field"},
		{120.121 ,12.722,354.20 ,"Power plant shortcut"},
		{-100.95,0.584,313.079,"Powerplant main area"},
		{-229.199 ,5.133 ,-222.29 ,"Next to pool"},
		{263.02700805664,7.8882312774658,-210.05313110352,"Flanders Card from Homer 2"},
		{245.31123352051,18.873668670654,-352.55676269531,"Lard Lads Card from Homer 2"},
		{243.2347869873,12.139566421509,-335.02828979492,"Card Between Lard Lads and Gas station from Marge"},
		{-98.147750854492,8.8505191802979,-608.88720703125,"School Bus card from Homer 2"},
		{414.92489624023,3.2752170562744,473.0612487793,"Trailerpark card from Marge"},
		{-165.39199829102,16.971042633057,-192.0013885498,"Roof Card from Marge"},
		{152.10539245605,11.525991439819,-190.92462158203,"Playground card from Homer 2"},
		{61.262,6.744,297.2622,"Powerplant enterance"},
	},
	{ --Level 2
		...
		{-180.64682006836,15.199880599976,20.592338562012,"Moes Roof card from Apu"},
		{-218.67234802246,5.258668422699,41.943466186523,"The Legitimate Businessman's Social Club card from Apu"},
		{-367.27410888672,16.653484344482,154.78942871094,"Train card from Apu"},
		{-286.87100219727,49.375175476074,568.45178222656,"Matlock Expressway card from Apu"},
		{-218.66571044922,43.457744598389,451.86560058594,"Monorail card from apu"},
		{-190.31 ,17.6622 ,33.491 ,"On top of moes"},
		{-103.502 ,14.892 ,-7.777 ,"Lard Lads"},
		{45.608 ,-20.00 ,-199.95 ,"Inside moes"},
		{-243.275 ,10.654 ,190.074 ,"Toms Grocery next to car wash"},
		{-157.515 ,9.967 ,160.294 ,"Outside of carwash"},
		{-401.698,16.882 ,147.217 ,"On Train"},
		{-352.289,10.306,193.650 ,"Train shortcut"},
		{-409.626,10.365,132.806 ," Behind Train near drop from Better Than Beef"},
		{-409.626 ,10.365 ,232.879 ,"Behind Train"},
		{-297.57 ,9.605 ,186.888 ,"In trainyard near start of 5-1"},
		{-361.836,9.244, 311.273,"Next to start of 2-B"},
		{-259.134 ,8.801 ,385.933 ,"Corner next to DMV"},
		{-2.02,-20 ,-202.89 ,"In DMV"},
		{-312.62, 12.877, 406.388 ,"On top of Try-and-save vend"},
		{-326.208,10.269 ,410.374 ,"Try-and-Save Carpark "},
		{-323.758,13.683,370.341,"On top of bomb gag"},
		{-406.872,11.750,391.819 ,"End of Ralph Race"},
		{-536.774, 23.876, 556.378 ,"Matlock Expressway Shortcut East side to Downtown"},
		{-441.578,51.094,586.093,"Middle of Matlock Expressway"},
		{-457.567 ,24.650 ,616.515 ,"Matlock Expressway Shortcut Downtown to East side"},
		{-406.020 ,26.754 ,510.552 ,"Where Snake spawns in Bart n Frink"},
		{-249.014,26.336,627.172,"Entrance of highway on downtown side"},
		{249.014,44.299,447.014,"Middle of air in downtown"},
		{-125.861,32.245,509.608,"Start of 2-3"},
		{-139.255,38.052,433.216,"Sit and Rotate"},
		{-141.905,39.091,437.125,"Sit and Rotate"},
		{-133.815,47.562,434.369,"Sit and Rotate"},
		{-20.073,36.016,456.67,"Police Station"},
		{-36.843,30.985,414.210,"Krusty Burger"},
		{5.163,49.275,329.388,"Firetruck Jump"},
		{12.48,35.73,330.572,"Firetruck"},
		{27.831,33.875,367.530,"Vend in Downtown"},
		{113.38,32.181,322.92,"End of 2-4"},
		{170.576,25.842,443.24,"Tunnel"},
		{165.973,14.465,240.42,"Close to entrance of tunnel"},
		{116.863,16.893,306.55,"Duff Brewery"},
		{134.743,14.711,162.800,"Town hall"},
		{234.43,8.375,107.243,"Monkey Box"},
		{255.317,13.013,92.071,"Hosptial Sign"},
		{335.273,17.111,28.694,"Hosptial Sign"},
		{295.710,12.415,5.366,"Hosptial Sign"},
		{290.928,8.351,-41.838,"Java Server"},
		{221.658,13.801,-89.520,"Museum Sign"},
		{241.268,9.288,-9.470,"Fountain"},
		{183.25,10.42,-29.777,"Above gazebo"},
		{136.405,12.449,-30.79,"Courthouse"},
		{72.503,10.846,-63.22,"Krusty Burger Carpark"},
		{69.152,8.179,-39.287,"Krusty burger carpark"},
		{5.535,8.304,-78.719,"First drops in Better than Beef"},
		{34.126,9.432,-5.483,"Below Dirt Jump"},
		{1.082,20.019,-12.366,"Construction Box"},
		{-4.0535,12.381,0.173,"Halway up elevator"},
		{14.884,12.382,-49.061,"Shortcut near Krusty Burger"},
		{127.723,10.341,45.108,"Catapult"},
		{77.31,9.903,146.335,"Road next to Town hall"},
		{215.873,9.103,105.734,"Monkey start"},
		{271.577,8.767,65.838,"Where you buy Mr Plow"},
		{199.330,10.382,-100.84,"Next to Museum"},
		{293.679,6.722,-99.269,"Next to Museum"},
		{-26.067,13.551,-7.15,"After Dirt Jump"},
		{134.68,14.768,113.901,"Town Hall"},
		{-105.99,10.717,-44.652,"In front of the firetruck next to moes"},
		{111.482,10.895,231.568,"Carpark next to Ralph race start"},
		{-216.99,11.211,139.707,"Dumpster next to carwash"},
		{49.959,-20.000,-196.378,"In moes"},
		{-99.826,12.606,-13.165,"Lard Lads"},
	},
	{ --Level 3
...
if Settings.RandomCardLocations then Seed.AddSpoiler("CARD LOCATORS:") end
for i=1,7 do
	...
	if Settings.RandomCardLocations then
		...
		for j=1,7 do
			...
			P3DFile:AddChunk(LocatorChunk:Output())
			Seed.AddSpoiler("L" .. i .. "C" .. j .. "|" .. Locator[4])
		end
	end
	
	Cache["Level" .. i] = P3DFile:Output()
end
if Settings.RandomCardLocations then Seed.AddSpoiler("") end
